          ...
          <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
            ...
            <ul className="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 sm:mt-0">
              {FooterData.simpleFooter.map((ele, ind) => (
                <li key={ind}>
                  <a href={ele.path} className="hover:underline me-4 md:me-6">
                    {ele.name}
                  </a>
                </li>
              ))}
        ...
        <footer className="bg-white rounded-lg shadow-2xl">
          <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              >
                <GestinyLogo height={null} width={null} />
            ...
            <span className="block text-sm text-gray-500 sm:text-center ">
              © {currentYear}{" "}
              <a href="gestini.com" className="hover:underline">
                Gestini
              </a>
              . All Rights Reserved.
            </span>
        ...
        <footer className="bg-white shadow-2xl">
          <div className="mx-auto w-full ">
            ...
            <div className="px-4 py-6 bg-gray-100 md:flex md:items-center md:justify-between">
              <span className="text-sm text-gray-500 sm:text-center">
                © {currentYear} Gestini. All Rights Reserved.
              </span>
