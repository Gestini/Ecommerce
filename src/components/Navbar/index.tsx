  ...
  return (
    <div className="sticky top-0 left-0  z-20">
      ...
      >
        ...
        <div className="">
          <button className="flex items-center gap-2 p-2 bg-c-primary-variant-1 w-full mb-1 rounded-md text-white text-[16px] justify-center">Enviar con <FaWhatsapp /></button>
