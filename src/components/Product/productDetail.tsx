...
const ProductDetail = () => {
  ...
  const closeDetail = () => {
    dispatch(setCurrentProduct(null as unknown as Product));
  };
  ...
  return (
    product && (
      <div className="fixed top-0 left-0 w-full h-screen bg-opacity-50 flex items-center justify-center z-30">
        <div
          onClick={closeDetail}
          className="absolute w-full h-screen inset-0 bg-black bg-opacity-50 flex items-center justify-center z-20"
        ></div>
        <div className="relative top-0 left-0 bg-white rounded-lg shadow-lg w-[1000px] h-[450px] p-6 flex z-50">
          ...
          <div className="w-1/2 pl-6 flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-800 text-xl font-bold text-[22px]">
